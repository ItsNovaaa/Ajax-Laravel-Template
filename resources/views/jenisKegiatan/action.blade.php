<div class="dropdown">
    ...
    <ul class="dropdown-menu">
      <li><a class="dropdown-item conva-edit" href="#" data-id="{{ $data->id_kegiatan }}">Edit</a></li>
      <li><a class="dropdown-item delete-data" href="#" data-id="{{ $data->id_kegiatan }}">Delete</a></li>
    </ul>
  </div>