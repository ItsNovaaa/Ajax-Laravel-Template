  ...
  <div class="offcanvas-header">
    ...
    {{-- @csrf --}}
      <div class="offcanvas-body mx-3">
        ...
        <div class="mb-4 row ">
          <span>Kode risk</span>
          <input class="form-control" type="text" name="kode_risk"  placeholder="Insert kode riske" aria-label="default input example" id="kode_risk">
        </div>
        <div class="mb-4 row  ">
          <span class="text-align-start">Insert Audite / Unit</span>      
          <select id="level_risk" class="form-select" placeholder="Insert kode kegiatane" aria-label="Default select example">
