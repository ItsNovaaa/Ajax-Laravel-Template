<div class="dropdown">
    ...
    <ul class="dropdown-menu">
      <li><a class="dropdown-item conva-edit" href="#" data-id="{{ $data->id_position }}">Edit</a></li>
      <li><a class="dropdown-item delete-data" href="#" data-id="{{ $data->id_position }}">Delete</a></li>
    </ul>
  </div>