    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex mb-2 justify-content-between">
                ...
                <a class="btn btn-primary  conva" href="{{ route('penalty.create') }}" >
                  Tambah Jenis Staff
                </a>                 
            </div>
            <table class="table" id="datatable">
                ...
                <tbody>
                    @foreach($modelPenalty as $datapenalty)
                        <tr style="width: 100px" >
                            {{-- <th style="width: 100px">No</th> --}}
                            <td colspan="3" style="width: 100px">{{ $datapenalty->penalty_name }}</td>
                            @if($datapenalty->penalty_isaktif == '1')
                            ...
                            <td colspan="1" style="width: 100px">
                                ...
                                <ul class="dropdown-menu">
                                    <form action="" method="POST">
                                        {{-- @csrf --}}
                                        {{-- @method('DELETE') --}}
                                        <li><a class="dropdown-item conva-edit" href="" data-id="">Edit</a></li>
                                        <li><a class="dropdown-item delete-data" href="" data-id="">Delete</a></li>
                                    </form>
                                </ul>
                            </td>                       
                        </tr>
